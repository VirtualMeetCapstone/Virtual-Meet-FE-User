...
export class RoomComponentComponent implements OnInit {
  ...
  private initializeEventListeners(): void {
    ...
    this.roomHubService.receiveVipJoinNotification((username) => {
      console.log('VIP Join Notification:', username);
      this.showVipJoinNotification(username);
    });
  }
  ...
  private showVipJoinNotification(username: string) {
