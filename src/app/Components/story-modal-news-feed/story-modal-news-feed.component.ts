...
import { ModalDeleteStoryNewsFeedComponent } from './modal-delete-story-news-feed/modal-delete-story-news-feed.component';
import { StoryService } from '../../services/story-service/story-service.service';

@Component({
  selector: 'app-story-modal-news-feed',
  templateUrl: './story-modal-news-feed.component.html',
  styleUrls: ['./story-modal-news-feed.component.scss'],
})
export class StoryModalNewsFeedComponent implements OnInit, OnDestroy {
  ...
  constructor(
    public dialogRef: MatDialogRef<StoryModalNewsFeedComponent>,
  ...
  deleteStory(): void {
    ...
    const dialogRef = this.dialog.open(ModalDeleteStoryNewsFeedComponent, {
      width: '300px',
